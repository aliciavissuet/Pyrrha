...
class MySavedAlbums extends React.Component {
    ...
    render(){
        ...
        const alList = als.map((album, i) => {
            return (<li className='track-item-li' key={i}><AlbumItem className='Track-item' playAlbum={this.props.playAlbum} userId={userId} album={album} artist={artists[album.artistIds[0]]} removeSave={this.removeSave} postStation={this.props.postStation}/></li>)
        });
