...
class TracksDisplay extends Component {
    ...
    render(){
        ...
        const tL = tracks.map((track, i) => {
            return (<li className='track-item-li' key={i}><TrackItem className='Track-item' playTrack={this.props.fetchSingleTrack} track={track} artist={artists[track.artistId]} album={albums[track.albumId]}removeSave={this.removeSave} postStation={this.props.postStation}/></li>)});
